## TIER IV universe / split mirror (simulator)

This repository split mirrors the simulator subtrees of several upstream repositories, used for TIER IV release workflows.
...
| Branch | Contents |
| --- | --- |
| `awf-latest/universe` | `autowarefoundation/autoware_universe:main`, `simulator/` |
| `awf-system-latest` | the same filter of the same upstream, published a second time |
